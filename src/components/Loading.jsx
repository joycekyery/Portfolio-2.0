...
const SvgPathLoader=()=> {
    ...
    return (
      <svg
        ...
        width="141.73px" height="141.73px" viewBox="0 0 141.73 141.73"
      >
        <motion.path
          className="outline1" 
        ...
        <motion.path
          ...
          c0,0,6.174,10.305,14.256,16.298c8.081,5.995,18.587,11.315,22.358,5.658c3.771-5.658-4.04-8.756-5.455-9.228
          c-1.373-0.457-11.874-4.822-18.506-13.137C78.88,89.424,75.827,82.471,79.194,78.9z"/>
          <path fill="#ffffff" d="M46.25,56.774c0.501,0.571,0.444,1.439-0.126,1.94l0,0c-0.57,0.501-1.439,0.444-1.94-0.126L40.5,54.392
		c-0.501-0.571-0.444-1.439,0.126-1.94l0,0c0.571-0.501,1.439-0.444,1.94,0.126L46.25,56.774z"/>
        <path fill="#ffffff" d="M59.25,44.941c0.501,0.571,0.444,1.439-0.126,1.94l0,0c-0.57,0.501-1.439,0.444-1.94-0.126L53.5,42.559
		c-0.501-0.571-0.444-1.439,0.126-1.94l0,0c0.571-0.501,1.439-0.444,1.94,0.126L59.25,44.941z"/>
        <path fill="#ffffff" d="M50.172,57.94c-0.276,0-0.5-0.224-0.5-0.5s0.224-0.5,0.5-0.5c3.492,0,6.333-2.878,6.333-6.417c0-0.276,0.224-0.5,0.5-0.5
