...
// E3CACA
  ...
  useFrame((state, dt) => {
    ...
    if(isRotatetion){
        meshRef.current.children[0].children[0].children[0].children[0].rotation.z=time*2;
        meshRef.current.rotation.x=0;
        meshRef.current.rotation.y=0;
        meshRef.current.rotation.z=0.3;

    }else{
        meshRef.current.children[0].children[0].position.y=Math.sin(time)*0.3;

    }

    //shader
        meshRef.current.children[0].children[0].children[0].children[0].material=shader;
        meshRef.current.children[0].children[0].children[0].children[0].material.uniforms.time.value =time;
}
  });
  ...
  return (
                <mesh ref={meshRef} onClick={(e)=>{meshOnclick(e)}} 
